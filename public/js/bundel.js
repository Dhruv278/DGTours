...
exports.showAlert = exports.hide = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 8:
            ...
            (0, _alert.showAlert)('error', 'opps Somthing is wrong please try again!');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _axios.default.post('http://127.0.0.1:3000/api/v1/user/signup', form);

          case 3:
            res = _context.sent;

            if (res.data.status === 'success') {
              (0, _alert.showAlert)('success', 'sign In successfully!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"sendemail.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.reset = exports.sendmail = void 0;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alert.showAlert)('success', 'We send Mail On your Account ,Please check!');
            }
...
var reset = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(Password, confirm_password, token) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function reset(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();
...
if (document.querySelector('#loginForm')) {
  document.querySelector('#loginForm').addEventListener('submit', function (el) {
    el.preventDefault();
...
if (document.querySelector('#signupForm')) {
  document.querySelector('#signupForm').addEventListener('submit', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(el) {
      var infile, email, password, confirm_password, name, form;
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              el.preventDefault();
              infile = document.querySelector('#inputImage');
              email = document.querySelector('#exampleInputEmail1').value;
              password = document.querySelector('#exampleInputPassword1').value;
              confirm_password = document.querySelector('#exampleInputPassword2').value;
              name = document.querySelector('#inputName').value;
              form = new FormData(); // console.log(infile.files[0])
...
if (document.querySelector('.nav--links2')) {
  ...
  var navlinks = document.querySelector('.nav--links2');
...
if (document.querySelector('.form-user-data')) {
  document.querySelector('#saveaccountsettings').addEventListener('click', function (e) {
    e.preventDefault();
    var name = document.querySelector('#name').value;
    var email = document.querySelector('#email').value;
    var file = document.querySelector('#updatedimage').files[0];
    var form = new FormData();
    form.append('name', name);
    form.append('email', email);
    form.append('file', file);
    (0, _updateuser.updateme)(form, 'data');
  });
}

if (document.querySelector('.form-user-settings')) {
  document.getElementById('savepassword').addEventListener('click', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
      var currentPassword, Password, confirm_password;
      return regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
